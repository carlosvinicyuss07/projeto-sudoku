...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                default -> System.out.println("Opção invélida, selecione uma das opções do menu");
            }
        }
    }
    ...
    private static void removeNumber() {
        ...
        System.out.println("Informe a coluna em que deseja remover: ");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha em que deseja remover: ");
        var row = runUntilGetValidNumber(0, 8);
